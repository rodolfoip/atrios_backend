...
const makeUsabilityTestRepository = () => {
  ...
  usabilityTestRepositorySpy.usabilityTest = new UsabilityTest('60dbc3b024e294424492b6f9', 'any_name', 'any_accessCode', 'any_prototypeLink', 'any_externalLink', 'any_userId')
...
describe('Describe Use Case', () => {
  ...
  test('should return null if no result has founded', async () => {
    ...
    const usabilityTest = await sut.find('any_userId', '60dbc3b024e294424492b6f9')
